...
export default function Footer() {
  ...
  const cols = [
    {
      heading: t.footer.links.company,
      links: [
        { label: t.footer.nav.about, href: '#' },
        { label: t.footer.nav.careers, href: '#' },
        { label: t.footer.nav.blog, href: '#' },
      ],
    },
    {
      heading: t.footer.links.services,
      links: [
        { label: t.footer.nav.mca, href: '/#services' },
        { label: t.footer.nav.loc, href: '/#services' },
        { label: t.footer.nav.mortgage, href: '/#services' },
        { label: t.footer.nav.fixed, href: '/#services' },
      ],
    },
    {
      heading: t.footer.links.legal,
      links: [
  ...
  return (
    <footer className="snap-section bg-ff-surface border-t border-ff-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex flex-col gap-1.5 text-sm">
              <a href={`mailto:${t.footer.nav.email}`} className="text-ff-muted hover:text-ff-accent transition-colors flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                {t.footer.nav.email}
              </a>
              <a href={`tel:${t.footer.nav.phone}`} className="text-ff-muted hover:text-ff-accent transition-colors flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {cols.map((col) => (
            <div key={col.heading}>
              ...
              <ul className="space-y-2.5">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <Link href={link.href} className="text-ff-muted text-sm hover:text-ff-accent transition-colors">
                      {link.label}
                    </Link>
                  </li>
                ))}
